...
//####################################################################################################################//
	...
	export const Markdown = ()=>(
		...
		>
			<defs>
				<radialGradient id="MarkdownLogo-Gradient">
					<stop offset="33%"  stop-color="hsl(214, 70%, 70%)"></stop>
					<stop offset="100%" stop-color="hsl(261, 70%, 80%)"></stop>
				</radialGradient>
			</defs>
			<path
				...
				fill="url('#MarkdownLogo-Gradient')"
			/>
		</svg>
	)
